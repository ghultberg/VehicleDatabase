...
exports.insert = function(params, callback) {
    var query = 'INSERT INTO vehicle (model, model_year, price, horsepower, torque, curb_weight, mpg, cylinders) ' +
        'VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)';

    // the question marks in the sql query above will be replaced by the values of the
    // the data in queryData
    var queryData = [params.model, params.model_year, params.price, params.horsepower, params.torque,
